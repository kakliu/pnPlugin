...
var krpanoplugin = function()
{
    ...
    local.registerplugin = function(krpanointerface, pluginpath, pluginobject)
    {
        ...
        plugin.registerattribute("x", 100);
        ...
        if (havegraphiccontent) // this code here is only an example for how-to add addtional graphical content!
        {
            ...
            plugincanvas.style.background = "#ffffff";
            plugincanvas.style.width  = "100%";  // automatic scale with parent
            plugincanvas.style.height = "100%";
            plugincanvas.onselectstart = function() { return true; };  // fix select mouse cursor
            plugincanvas.onclick = function() { krpano.call("skin_load_scene('FFGbXjy48300')"); };
